...
template.url = "https://github.com/toastygm/hm-loc-erone";
template.bugs = "https://github.com/toastygm/hm-loc-erone/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-erone/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-erone/releases/download/v${pkg.version}/module.zip`;
